...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" action="${app}/myMessage/messageList.do" target="listQuery">
	...
	<script type="text/javascript">
		...
		function add() {
			MyWindow.OpenCenterWindowScroll('${app}/myMessage/messageEdit.do?method=add','messageEdit',600,1000);
		}
	</script>
</html>
