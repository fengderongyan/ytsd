...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" action="${app}/salestatus/list.do" target="listQuery">
					...
					<table class="search" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="outDetail2" style="width: 100px;">
								<input type="text" id="build_num" name="build_num"/>
							</td>
						</tr>
					</table>
	...
	<script type="text/javascript">
		...
		function add() {
			MyWindow.OpenCenterWindowScroll('${app}/salestatus/edit.do?method=add','add',400,700);
		}
	</script>
</html>
