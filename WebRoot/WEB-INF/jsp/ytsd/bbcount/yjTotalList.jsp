...
<head>
	...
	<body>
		<sgy:csrfToken />
		<display:table name="list" requestURI="${app}/yjbbCount/yjTotalFrame.do.do"
			...
			<display:column title="饮酒类别" property="concrete_type"/>
			<display:column title="次数" property="totalTimes"/>
		</display:table>
	</body>
