...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" action="${app}/banner/bannerList.do" target="listQuery">
	...
	<script type="text/javascript">
		...
		function add() {
			MyWindow.OpenCenterWindowScroll('${app}/banner/bannerEdit.do?method=add','bannerEdit',400,700);
		}
	</script>
</html>
