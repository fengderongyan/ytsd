...
public class Constants {
    public static final String SYSTEMNAME = "ytsd";
    public static String APP_HTTP_KEY = "ytsd";
    public static String COOKIE_SESSION_ID = "JSESSIONID_ytsd";
    ...
    public static String SYSTEM_ATTACHMENT_PATH = ATTACHMENT_ROOT + "ytsd/";
    ...
    public static final String DOWNLOAD = "/ytsd/servlet/download"; //下载附件
