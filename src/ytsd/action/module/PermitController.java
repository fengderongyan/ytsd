...
import ytsd.service.module.PermitService;
...
public class PermitController extends BaseController {
    ...
    public String roleQuery() {
        ...
        return COM_PATH + "ytsd/module/module/permit/role_query";
    }
    ...
    public String queryPermit() {
        return COM_PATH +"ytsd/module/module/modulepermit/modulepermit_query";
    }
    ...
    public String showReplaceRole(HttpServletResponse response) {
        ...
        return COM_PATH +"ytsd/module/module/modulepermit/ajaxModuleRole";
    }
