...
public class LoginController extends BaseController {
	...
	public String login() {
		...
		log.debug("count:" + loginService.testQueryForInt());
...
//                logger.debug("修改密码");
//                return "redirect:/ytsd/personalsetting/changePassWord.do?operator_id="+operator_id;
//            }
           return "redirect:/login/index.do"; 
		}
		
		return COM_PATH +"ytsd/login/loginResult";
	}
    ...
    public String editPwdFrame(){
        return COM_PATH +"ytsd/login/editPwd";
    }
