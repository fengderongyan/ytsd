package ytsd.action.pushinfo;

import ytsd.service.pushinfo.PushInfoService;
...
public class PushInfoController extends BaseController {
    ...
    public String pushFrame(){
        return COM_PATH +"ytsd/pushinfo/pushFrame";
    }
    ...
    public String pushList(){
        ...
        return COM_PATH +"ytsd/pushinfo/pushList";
    }
    ...
    public String pushEdit(){
        ...
        return COM_PATH +"ytsd/pushinfo/pushEdit";
    }
