...
import ytsd.service.sys.UserCfgService;
...
public class UserCfgController extends BaseController {
    ...
    public String userFrame() {
        ...
        return COM_PATH +"ytsd/sys/usercfg/frameUser";
    }
    ...
    public String queryUser() {
        ...
        return COM_PATH +"ytsd/sys/usercfg/listUser";
    }
    ...
    public String editUser() {
        ...
        request.setAttribute("rolesList", userCfgService.getRoleList(request));
        return COM_PATH +"ytsd/sys/usercfg/editUser";
    }
    ...
    public String editMoreUser() {
        return COM_PATH +"ytsd/sys/usercfg/editMoreUser";
    }
    ...
    public String qmInfoUpload() {
        ...
        return COM_PATH +"ytsd/sys/usercfg/qminfoup";
    }
    ...
    public String impFile(@RequestParam(value="file") CommonsMultipartFile file) {
        ...
        //return COM_PATH +"ytsd/cgjc/clsc/saveResult";
        return COM_PATH + "ytsd/sys/usercfg/saveResult";
    }
    ...
    public String getRoleListByOgrLevel() {
        ...
        return COM_PATH +"ytsd/sys/usercfg/ajaxrolelist";
    }
    ...
    public String importCheckFrame(){
        return COM_PATH +"ytsd/sys/usercfg/impframe";
    }
