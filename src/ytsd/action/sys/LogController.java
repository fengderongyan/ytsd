package ytsd.action.sys;

import ytsd.service.sys.LogService;
...
public class LogController extends BaseController {
    ...
    public String sysLogMain(){
        return COM_PATH +"ytsd/sys/log/frame";
    }
    ...
    public String nodeHisFrame(){
        ...
        return COM_PATH +"ytsd/sys/log/nodelog/nodeHisFrame";
    }
    ...
    public String nodeHisList(){
        ...
        return COM_PATH +"ytsd/sys/log/nodelog/nodeHisList";
    }
    ...
    public String loginHisFrame(){
        request.setAttribute("begin_date", DateHelper.getToday("yyyy-MM-dd"));
        request.setAttribute("end_date", DateHelper.getToday("yyyy-MM-dd"));
        return COM_PATH +"ytsd/sys/log/loginlog/loginHisFrame";
    }
    ...
    public String loginHisList(){
        ...
        return COM_PATH +"ytsd/sys/log/loginlog/loginHisList";
    }
    ...
    public String mobileLoginHisFrame(){
        request.setAttribute("begin_date", DateHelper.getToday("yyyy-MM-dd"));
        request.setAttribute("end_date", DateHelper.getToday("yyyy-MM-dd"));
        return COM_PATH +"ytsd/sys/log/mobiloginlog/loginHisFrame";
    }
    ...
    public String mobileLoginHisList(){
        ...
        return COM_PATH +"ytsd/sys/log/mobiloginlog/loginHisList";
    }
    ...
    public String infoDownloadHisFrame(){
        request.setAttribute("begin_date", DateHelper.getToday("yyyy-MM-dd"));
        request.setAttribute("end_date", DateHelper.getToday("yyyy-MM-dd"));
        return COM_PATH +"ytsd/sys/log/infodownloadlog/infoDownloadHisFrame";
    }
    ...
    public String infoDownloadHisList(){
        ...
        return COM_PATH +"ytsd/sys/log/infodownloadlog/infoDownloadHisList";
    }
}
